...
# after final join in the end missing coordinates and PLZ for location "Seeg" were detected, data was missing in gemeinden dataset: Add missing data as row to gemeinden dataset
gemeinden_clean <- rbind(gemeinden, c(87637, "SEEG", 10.610416, 47.654222))
