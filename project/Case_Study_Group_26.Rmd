...
t11 <- rename(t11, ID = ID_T11)
t14 <- rename(t14, ID = ID_T14)
t15 <- rename(t15, ID = ID_T15)
t16 <- rename(t16, ID = ID_T16)
t19 <- rename(t19, ID = ID_T19)
t20 <- rename(t20, ID = ID_T20)

# use rbind to bind rows of all data sets into one data set
einzelteile <- rbind(t11, t14, t15, t16, t19, t20)
