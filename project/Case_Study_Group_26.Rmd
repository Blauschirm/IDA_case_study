---
title: "Case Stud zur Analyse der Lieferkette defekter Fahrzeugkomponenten"
...
## Import relevant Einzelteil data sets
...
```{r import data 2, results = 'hide', message= FALSE, warning = FALSE}
## Import Einzelteil data sets

# read_csv2 (delim = ";") and read_csv (delim = ","), coerce col_type for t15 because data is split on several columns which causes parsing errors
...
```{r tidy data einzteile, results = 'hide', message= FALSE, warning = FALSE}
...
```{r tidy data einzteile 2, results = 'hide', message= FALSE, warning = FALSE}
...
```{r tidy data bestandteile_komponenten, results = 'hide', message= FALSE, warning = FALSE}
...
```{r tidy data komponenten, results = 'hide', message= FALSE, warning = FALSE}
...
```{r tidy data fahrzeuge und bestandteile, results = 'hide', message= FALSE, warning = FALSE}
...
```{r tidy data zulassungen and geodaten, results = 'hide', message= FALSE, warning = FALSE}
...
```{r bind rows, results = 'hide', message= FALSE, warning = FALSE}
...
### Joining mit relationalen Datensätzen

Die "Einzelteil"-Datensätze sind mit den Komponenten über die relationalen Tabellen " durch die Variablen "ID_Einzelteile" und "ID_Komponente" verbunden

```{r join relational tables, results = 'hide', message= FALSE, warning = FALSE}
...
### Joining mit Geodaten



```{r join geodata, results = 'hide', message= FALSE, warning = FALSE}
...
```{r final join, results = 'hide', message= FALSE, warning = FALSE}
...
kable(final_joined[1:5, 1:6], caption = "Finaler Datensatz Teil 1")
kable(final_joined[1:5, 7:12], caption = "Finaler Datensatz Teil 2")
kable(final_joined[1:5, 13:18], caption = "Finaler Datensatz Teil 3")
