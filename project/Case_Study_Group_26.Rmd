...
fahrzeuge_clean <- fahrzeuge %>%
  select(-Fehlerhaft_Datum, -Fehlerhaft_Fahrleistung, -Herstellernummer)

# join Einzelteile and Komponenten and Fahrzeuge by ID_Sitze column, remove Fehlerhaft column (of fahrzeuge table)

einz_komp_fahrz <- full_join(einzelteile_clean, komponenten_clean, by = "ID_Sitze", suffix = c("_Einzelteil", "_Komponente")) %>%
  full_join(., fahrzeuge_clean, by ="ID_Sitze") %>%
...
einz_komp_fahrz_fehlerhaft_111 <- einz_komp_fahrz %>%
