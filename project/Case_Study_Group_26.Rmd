...
Eine Auswahl einzelner Gemeinden filtert die ausgewerteten Daten sowohl für das Balkendiagramm als auch die Kartendarstellung. In der Kartendarstellung In der Tabelle wird für die jeweiligen Gemeinden zusätzlich die Anzahl der zugelassenen betroffenen Fahrzeuge angezeigt.

Die Auswahl der Bauteile filtert lediglich die für die Kartendarstellung ausgewerteten Daten, da eine grafische Darstellung der Fahrzeugzulassungen nach einzelnen Bauteilen keine gewinnbringende Information liefert und Bauteile je Fahrzeug über die Datentabellen ermittelt werden können.

In der Kartendarstellung wird durch die Auswahl von Gemeinden bzw. Bauteilen lediglich die Darstellung der Lieferwege generiert.
...
Zur Nutzerfreundlichkeit filtert die Datentabelle ebenfalls die Kartendarstellung. Die Suche und Auswahl der Daten erfolgt analog zu den o.g. Datentabellen.
