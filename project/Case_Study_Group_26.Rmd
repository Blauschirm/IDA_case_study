...
# after final join in the end missing coordinates and PLZ for location "Seeg" were detected, data was missing in gemeinden dataset: Add missing data as row to gemeinden datase

gemeinden_clean <- rbind(gemeinden, list("87637", "SEEG", as.numeric(10610416), as.numeric(47654222)))
