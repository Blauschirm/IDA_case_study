...
## Clean and tidy Zulassungen and Geodaten
...
# join einzelteile_, komponenten_, and fahrzeuge_clean by ID_Komponente column, remove Fehlerhaft column from fahrzeuge
einz_komp_fahrz <- full_join(einzelteile_clean, komponenten_clean, by = "ID_Komponente", suffix = c("_Einzelteil", "_Komponente")) %>%
...
final_joined_order <- final_joined[c(1:3,5,6,4,7:15,17,16)]
